...
@Entity
@Table(name = "materiasDesaprobadas")
public class MateriaDesaprobada {
	...
	public MateriaDesaprobada(String fecha, String nombreMateria, int notaMateria, String nombreProfesor) {
		this.fecha = fecha;
